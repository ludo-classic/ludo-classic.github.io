 ...
 * **Player Customization:** Choose your favorite token color before the game begins.
 * **In-Game Communication:**
   * Chat and talk with other players during the match.
   * Mute specific players anytime for a distraction-free experience.
 * **Interactive UI/UX:**
   * 3D-style rolling dice animation.
   * Smooth token (goti) movement animations.
   * Floating emoji reactions during gameplay.
 * **Audio & Controls:**
   * Includes background music, dice roll sounds, token move sounds, and winning fanfares.
   * Full audio controls—easily mute the game or turn off the Background Music (BGM) whenever you want.
